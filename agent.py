...
# 현재 task는 gpt로 amazon에서 SAMSUNG 32-Inch Class Full HD F6000 Smart TV 리뷰 탐색
import time
import json
import base64
import os
...
def run_agent():
    ...
    with sync_playwright() as p:
        ...
        task = """
        Search for SAMSUNG 32-Inch Class Full HD F6000 Smart TV on Amazon.

        Open the product page.

        Find the customer reviews.

        Summarize the main complaints from the reviews.
        """
